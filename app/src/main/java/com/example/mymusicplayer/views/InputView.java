 ...
 * 3、is_password：输入框中的内容是否需要以密文的形式展示
 * */
...
//      获取自定义属性
        inputIcon = typedArray.getResourceId(R.styleable.inputView_input_icon, R.mipmap.logo_red_img);
...
//      布局关联属性
        ...
        addView(mView);//把view添加到InputView中
    }
